"""
  ...
  本模型默认总参数量[参考基准：cifar10]：
    Total params:           2,272,642
    Trainable params:       2,263,042
...
class resnetse26(NetWork, AdvNet):
  """
    ResNet-SE-26
  """
  ...
  def args(self):
    ...
    self.RES_TIMES = [2, 3, 3]
    self.RES_F_A = [32, 64, 128]
  ...
  def build_model(self):
    ...
    self.model = Model(inputs=x_in, outputs=x, name='resnetse26')
...
if __name__ == "__main__":
  mod = resnetse26(DATAINFO={'INPUT_SHAPE': (32, 32, 3), 'NUM_CLASSES': 10})
